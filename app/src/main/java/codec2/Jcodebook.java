...
final class Jcodebook {
	...
	static final Jlsp_codebook lsp_cb[] = {
		/* codebook/lsp1.txt */
		new Jlsp_codebook( 1, 4,/* 16,*/ codes0 ),
		/* codebook/lsp2.txt */
		new Jlsp_codebook( 1, 4,/* 16,*/ codes1 ),
		/* codebook/lsp3.txt */
		new Jlsp_codebook( 1, 4,/* 16,*/ codes2 ),
		/* codebook/lsp4.txt */
		new Jlsp_codebook( 1, 4,/* 16,*/ codes3 ),
		/* codebook/lsp5.txt */
		new Jlsp_codebook( 1, 4,/* 16,*/ codes4 ),
		/* codebook/lsp6.txt */
		new Jlsp_codebook( 1, 4,/* 16,*/ codes5 ),
		/* codebook/lsp7.txt */
		new Jlsp_codebook( 1, 4,/* 16,*/ codes6 ),
		/* codebook/lsp8.txt */
		new Jlsp_codebook( 1, 3,/* 8,*/ codes7 ),
		/* codebook/lsp9.txt */
		new Jlsp_codebook( 1, 3,/* 8,*/ codes8 ),
		/* codebook/lsp10.txt */
		new Jlsp_codebook( 1, 2,/* 4,*/ codes9 ),
