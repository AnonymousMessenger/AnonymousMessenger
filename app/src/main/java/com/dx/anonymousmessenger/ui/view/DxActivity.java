...
//            System.exit(2);
    ...
    private void enableEdgeToEdge() {
        ...
        /**
         * Handle system window insets for a specific view
         */
    protected void handleSystemInsets(View view) {
    ...
    private TapSafeFrameLayout makeTapSafeWrapper(View v) {
        ...
        // Handle system insets for the wrapper
        handleSystemInsets(wrapper);
