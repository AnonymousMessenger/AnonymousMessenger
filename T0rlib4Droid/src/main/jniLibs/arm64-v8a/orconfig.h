...
/* # for 0.4.1.6 Approximate date when this software was released. (Updated
   when the version changes.) */
#define APPROX_RELEASE_DATE "2019-09-17"

/* tor's build directory */
#define BUILDDIR "/workspace/calling/tor-stuff/newcompiletor/tor-android/external/tor"

/* tor's configuration directory */
#define CONFDIR "/workspace/calling/tor-stuff/newcompiletor/tor-android/external/etc/tor"
...
#define PACKAGE_STRING "tor 0.4.1.6"
...
#define PACKAGE_VERSION "0.4.1.6"
...
#define SRCDIR "/workspace/calling/tor-stuff/newcompiletor/tor-android/external/tor"
