...
our %config = (
  AR => "llvm-ar",
  ARFLAGS => [ "rs" ],
  CC => "/Android/Sdk/ndk/21.3.6528147/toolchains/llvm/prebuilt/linux-x86_64/bin/i686-linux-android16-clang",
  CFLAGS => [ "-fbuild-session-timestamp=1234567890 -fdebug-prefix-map=OLD=NEW  -Os -I/workspace/calling/tor-stuff/newcompiletor/tor-android/external/include" ],
  ...
  build_infos => [ "./build.info", "crypto/build.info", "ssl/build.info", "apps/build.info", "test/build.info", "util/build.info", "tools/build.info", "fuzz/build.info", "crypto/objects/build.info", "crypto/md5/build.info", "crypto/sha/build.info", "crypto/hmac/build.info", "crypto/poly1305/build.info", "crypto/blake2/build.info", "crypto/siphash/build.info", "crypto/sm3/build.info", "crypto/des/build.info", "crypto/aes/build.info", "crypto/aria/build.info", "crypto/bf/build.info", "crypto/cast/build.info", "crypto/seed/build.info", "crypto/sm4/build.info", "crypto/chacha/build.info", "crypto/modes/build.info", "crypto/bn/build.info", "crypto/ec/build.info", "crypto/rsa/build.info", "crypto/dsa/build.info", "crypto/dh/build.info", "crypto/sm2/build.info", "crypto/dso/build.info", "crypto/buffer/build.info", "crypto/bio/build.info", "crypto/stack/build.info", "crypto/lhash/build.info", "crypto/rand/build.info", "crypto/err/build.info", "crypto/evp/build.info", "crypto/asn1/build.info", "crypto/pem/build.info", "crypto/x509/build.info", "crypto/x509v3/build.info", "crypto/conf/build.info", "crypto/txt_db/build.info", "crypto/pkcs7/build.info", "crypto/pkcs12/build.info", "crypto/ocsp/build.info", "crypto/ui/build.info", "crypto/cms/build.info", "crypto/ts/build.info", "crypto/cmac/build.info", "crypto/ct/build.info", "crypto/async/build.info", "crypto/kdf/build.info", "crypto/store/build.info", "test/ossl_shim/build.info" ],
  build_type => "release",
  builddir => ".",
  ...
  includes => [  ],
  lflags => [  ],
  lib_defines => [ "OPENSSL_PIC", "OPENSSL_CPUID_OBJ", "OPENSSL_BN_ASM_PART_WORDS", "OPENSSL_IA32_SSE2", "OPENSSL_BN_ASM_MONT", "OPENSSL_BN_ASM_GF2m", "SHA1_ASM", "SHA256_ASM", "SHA512_ASM", "RC4_ASM", "MD5_ASM", "RMD160_ASM", "VPAES_ASM", "GHASH_ASM", "ECP_NISTZ256_ASM", "POLY1305_ASM" ],
  libdir => "",
  major => "1",
  makedepprog => "\$(CROSS_COMPILE)/Android/Sdk/ndk/21.3.6528147/toolchains/llvm/prebuilt/linux-x86_64/bin/i686-linux-android16-clang",
  minor => "1.1",
  openssl_algorithm_defines => [ "OPENSSL_NO_CAMELLIA", "OPENSSL_NO_COMP", "OPENSSL_NO_IDEA", "OPENSSL_NO_MD2", "OPENSSL_NO_MD4", "OPENSSL_NO_MDC2", "OPENSSL_NO_RC2", "OPENSSL_NO_RC4", "OPENSSL_NO_RC5", "OPENSSL_NO_RMD160", "OPENSSL_NO_SRP", "OPENSSL_NO_WHIRLPOOL" ],
  openssl_api_defines => [  ],
  openssl_other_defines => [ "OPENSSL_RAND_SEED_OS", "OPENSSL_NO_AFALGENG", "OPENSSL_NO_ASAN", "OPENSSL_NO_CRYPTO_MDEBUG", "OPENSSL_NO_CRYPTO_MDEBUG_BACKTRACE", "OPENSSL_NO_DEVCRYPTOENG", "OPENSSL_NO_DTLS", "OPENSSL_NO_DTLS1", "OPENSSL_NO_DTLS1_2", "OPENSSL_NO_EC2M", "OPENSSL_NO_EC_NISTP_64_GCC_128", "OPENSSL_NO_EGD", "OPENSSL_NO_ENGINE", "OPENSSL_NO_EXTERNAL_TESTS", "OPENSSL_NO_FUZZ_AFL", "OPENSSL_NO_FUZZ_LIBFUZZER", "OPENSSL_NO_HEARTBEATS", "OPENSSL_NO_HW", "OPENSSL_NO_MSAN", "OPENSSL_NO_PSK", "OPENSSL_NO_SCTP", "OPENSSL_NO_SSL_TRACE", "OPENSSL_NO_SSL3", "OPENSSL_NO_SSL3_METHOD", "OPENSSL_NO_UBSAN", "OPENSSL_NO_UI_CONSOLE", "OPENSSL_NO_UNIT_TEST", "OPENSSL_NO_WEAK_SSL_CIPHERS", "OPENSSL_NO_DYNAMIC_ENGINE", "OPENSSL_NO_AFALGENG" ],
  openssl_sys_defines => [  ],
  openssl_thread_defines => [ "OPENSSL_THREADS" ],
  openssldir => "/workspace/calling/tor-stuff/newcompiletor/tor-android/external",
  options => "-D__ANDROID_API__=16 --prefix=/workspace/calling/tor-stuff/newcompiletor/tor-android/external --openssldir=/workspace/calling/tor-stuff/newcompiletor/tor-android/external no-afalgeng no-asan no-buildtest-c++ no-camellia no-comp no-crypto-mdebug no-crypto-mdebug-backtrace no-devcryptoeng no-dtls no-dtls1 no-dtls1_2 no-dynamic-engine no-ec2m no-ec_nistp_64_gcc_128 no-egd no-engine no-external-tests no-fuzz-afl no-fuzz-libfuzzer no-heartbeats no-hw no-idea no-md2 no-md4 no-mdc2 no-msan no-psk no-rc2 no-rc4 no-rc5 no-rmd160 no-sctp no-shared no-srp no-ssl-trace no-ssl3 no-ssl3-method no-ubsan no-ui-console no-unit-test no-weak-ssl-ciphers no-whirlpool no-zlib no-zlib-dynamic",
  perl_archname => "x86_64-linux-gnu-thread-multi",
  perl_cmd => "/usr/bin/perl",
  perl_version => "5.28.1",
  perlargv => [ "no-comp", "no-dtls", "no-ec2m", "no-psk", "no-srp", "no-ssl2", "no-ssl3", "no-camellia", "no-idea", "no-md2", "no-md4", "no-mdc2", "no-rc2", "no-rc4", "no-rc5", "no-rmd160", "no-whirlpool", "no-dso", "no-engine", "no-hw", "no-ui-console", "no-shared", "no-unit-test", "android-x86", "-D__ANDROID_API__=16", "--prefix=/workspace/calling/tor-stuff/newcompiletor/tor-android/external", "--openssldir=/workspace/calling/tor-stuff/newcompiletor/tor-android/external" ],
  perlenv => {
      "AR" => undef,
      "BUILDFILE" => undef,
      "CC" => "/Android/Sdk/ndk/21.3.6528147/toolchains/llvm/prebuilt/linux-x86_64/bin/i686-linux-android16-clang",
  ...
  prefix => "/workspace/calling/tor-stuff/newcompiletor/tor-android/external",
  processor => "",
  rc4_int => "unsigned int",
  sdirs => [ "objects", "md5", "sha", "hmac", "poly1305", "blake2", "siphash", "sm3", "des", "aes", "aria", "bf", "cast", "seed", "sm4", "chacha", "modes", "bn", "ec", "rsa", "dsa", "dh", "sm2", "dso", "buffer", "bio", "stack", "lhash", "rand", "err", "evp", "asn1", "pem", "x509", "x509v3", "conf", "txt_db", "pkcs7", "pkcs12", "ocsp", "ui", "cms", "ts", "cmac", "ct", "async", "kdf", "store" ],
  shlib_major => "1",
  shlib_minor => "1",
...
our %target = (
  ...
  cast_obj => "c_enc.o",
  cflags => "-pthread  -target i686-linux-android -gcc-toolchain \$(ANDROID_NDK_HOME)/toolchains/x86-4.9/prebuilt/linux-x86_64 --sysroot=\$(ANDROID_NDK_HOME)/platforms/android-16/arch-x86",
  chacha_asm_src => "chacha-x86.s",
  chacha_obj => "chacha-x86.o",
  cmll_asm_src => "cmll-x86.s",
  cmll_obj => "cmll-x86.o",
  cppflags => "-D__ANDROID_API__=16 -isystem \$(ANDROID_NDK_HOME)/sysroot/usr/include/i686-linux-android -isystem \$(ANDROID_NDK_HOME)/sysroot/usr/include",
  cpuid_asm_src => "x86cpuid.s",
  cpuid_obj => "x86cpuid.o",
  cxxflags => "-std=c++11 -pthread  -target i686-linux-android -gcc-toolchain \$(ANDROID_NDK_HOME)/toolchains/x86-4.9/prebuilt/linux-x86_64 --sysroot=\$(ANDROID_NDK_HOME)/platforms/android-16/arch-x86",
  defines => [  ],
