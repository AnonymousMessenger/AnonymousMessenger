...
our %config = (
  AR => "llvm-ar",
  ARFLAGS => [ "rs" ],
  CC => "/Android/Sdk/ndk/21.3.6528147/toolchains/llvm/prebuilt/linux-x86_64/bin/armv7a-linux-androideabi16-clang",
  ...
  libdir => "",
  major => "1",
  makedepprog => "\$(CROSS_COMPILE)/Android/Sdk/ndk/21.3.6528147/toolchains/llvm/prebuilt/linux-x86_64/bin/armv7a-linux-androideabi16-clang",
  minor => "1.1",
...
our %target = (
  ...
  cast_obj => "c_enc.o",
  cflags => "-pthread  -target armv7a-linux-androideabi -gcc-toolchain \$(ANDROID_NDK_HOME)/toolchains/arm-linux-androideabi-4.9/prebuilt/linux-x86_64 --sysroot=\$(ANDROID_NDK_HOME)/platforms/android-16/arch-arm",
  chacha_asm_src => "chacha-armv4.S",
  chacha_obj => "chacha-armv4.o",
  cmll_asm_src => "camellia.c cmll_misc.c cmll_cbc.c",
  cmll_obj => "camellia.o cmll_misc.o cmll_cbc.o",
  cppflags => "-D__ANDROID_API__=16 -isystem \$(ANDROID_NDK_HOME)/sysroot/usr/include/arm-linux-androideabi -isystem \$(ANDROID_NDK_HOME)/sysroot/usr/include",
  cpuid_asm_src => "armcap.c armv4cpuid.S",
  cpuid_obj => "armcap.o armv4cpuid.o",
  cxxflags => "-std=c++11 -pthread  -target armv7a-linux-androideabi -gcc-toolchain \$(ANDROID_NDK_HOME)/toolchains/arm-linux-androideabi-4.9/prebuilt/linux-x86_64 --sysroot=\$(ANDROID_NDK_HOME)/platforms/android-16/arch-arm",
  defines => [  ],
