...
our %config = (
  AR => "llvm-ar",
  ARFLAGS => [ "rs" ],
  CC => "/Android/Sdk/ndk/21.3.6528147/toolchains/llvm/prebuilt/linux-x86_64/bin/x86_64-linux-android21-clang",
  ...
  libdir => "",
  major => "1",
  makedepprog => "\$(CROSS_COMPILE)/Android/Sdk/ndk/21.3.6528147/toolchains/llvm/prebuilt/linux-x86_64/bin/x86_64-linux-android21-clang",
  minor => "1.1",
...
our %target = (
  ...
  cast_obj => "c_enc.o",
  cflags => "-pthread  -target x86_64-linux-android -gcc-toolchain \$(ANDROID_NDK_HOME)/toolchains/x86_64-4.9/prebuilt/linux-x86_64 --sysroot=\$(ANDROID_NDK_HOME)/platforms/android-21/arch-x86_64",
  ...
  cxxflags => "-std=c++11 -pthread  -target x86_64-linux-android -gcc-toolchain \$(ANDROID_NDK_HOME)/toolchains/x86_64-4.9/prebuilt/linux-x86_64 --sysroot=\$(ANDROID_NDK_HOME)/platforms/android-21/arch-x86_64",
  defines => [  ],
